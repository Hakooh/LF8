...
insert into users (id, day_of_birth, e_mail, first_name, gender, last_login, last_name, password) values (2, '1985-03-10', 'test@hotmail.de', 'Gerda', 'Female', '2022-08-06', 'Gunde', 'password');
insert into users (id, day_of_birth, e_mail, first_name, gender, last_login, last_name, password) values (3, '1984-06-22', 'mega@hotmail.de', 'Laura', 'Female', '2022-05-18', 'Schmidt', 'password');
insert into users (id, day_of_birth, e_mail, first_name, gender, last_login, last_name, password) values (4, '1982-01-05', 'super@hotmail.de', 'Susanne', 'Female', '2022-07-10', 'Sunder', 'password');
insert into users (id, day_of_birth, e_mail, first_name, gender, last_login, last_name, password) values (5, '1980-10-10', 'lolo@hotmail.de', 'Klaus', 'Male', '2022-09-03', 'Kong', 'password');
